...
from lucca_organization_python_sdk import configuration


class TestAxissectionsCreateNewAxisSectionResponse(unittest.TestCase):
    """AxissectionsCreateNewAxisSectionResponse unit test stubs"""
    pass
