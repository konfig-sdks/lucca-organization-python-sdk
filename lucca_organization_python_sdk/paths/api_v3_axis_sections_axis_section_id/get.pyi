...
from lucca_organization_python_sdk.model.axissections_get_by_id_response import AxissectionsGetByIdResponse as AxissectionsGetByIdResponseSchema

from lucca_organization_python_sdk.type.axissections_get_by_id_response import AxissectionsGetByIdResponse

from ...api_client import Dictionary
from lucca_organization_python_sdk.pydantic.axissections_get_by_id_response import AxissectionsGetByIdResponse as AxissectionsGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AxissectionsGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AxissectionsGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AxissectionsGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            axis_section_id=axis_section_id,
            **kwargs,
        )
        if validate:
            return AxissectionsGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AxissectionsGetByIdResponsePydantic, raw_response.body)
